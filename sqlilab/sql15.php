...
<body>
    ...
    <h1>Greetings, Chose anumber and i give you a sport<3 </h1>
    			
    <div class="button-container">
        <form method="get" action="">
        <label for="inputField">number:*</label>
        <input type="number" id="inputField2" name="username" required>
        <button type="submit" name="sub">Submit</button>
        </form>
       <h5>note: between<0-25></h5>
    </form>
    </div>
<?php
...
$sql3 = "SELECT * FROM sport WHERE id='$namee'";//String
